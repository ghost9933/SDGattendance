...
<div class="row"style="margin-top:70px; margin-bottom:30px">
    ...
    <div class="col-sm-4"style="padding-left:10rem">
        ...
        <br>
        <i class="fa  fa-cloud-upload fa-3x" aria-hidden="true"style="color: #9f1c32"></i>
        <br><br>
    ...
    <div class="col-sm-4"style="padding-left:7rem">
        <div class="card" style="width: 12rem;">
        <div class="card-body text-center">
        <br>
        <i class="fa fa-pencil-square-o fa-3x" aria-hidden="true"style="color: #9f1c32"></i>
        <br><br>
    ...
    <div class="col-sm-3"style="padding-left:6rem">
        ...
        <div class="card-body text-center">
        <br>
        <i class="fa fa-plus-circle fa-3x" aria-hidden="true"style="color: #9f1c32"></i>
        <br><br>
            <h5 class="card-title">ADD SPECIAL ATTENDANCE</h5>
        </div>
        </div>  
    </div>
...
<div class="row"style="margin-top:70px; margin-bottom:30px">
    ...
    <div class="col-sm-4"style="padding-left:11rem">
        <div class="card" style="width: 12rem;">
        <div class="card-body text-center">
        <br>
        <i class="fa fa-times fa-3x" aria-hidden="true"style="color: #9f1c32"></i>
        <br><br>
            <h5 class="card-title">GENERATE DEFAULTERS ATTENDANCE</h5>
        </div>
        </div>  
    </div>

    <div class="col-sm-4"style="padding-left:18rem">
        <div class="card" style="width: 12rem;">
        <div class="card-body text-center">
        <br><br>
